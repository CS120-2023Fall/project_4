...
// ����ICMP���ݰ����ڽ������Ҫͬ����Ҫ����������·���IP��, Ȼ���ٸ���ICMP���ͺŽ���, ���õ����ͺ�Ϊ`type 8`�������ŷ��ͺͽ������ݰ���ʱ�����
...
int PrintIPHeader(const u_char* packetData)
{
	...
	if ( ip_protocol->DstAddr != *dp) {
		return -1;//it is none of my business 
	}
	int ans = -1;
	...
	case 1: 
		...
		//printf("У���: %5X --> TTL: %4d --> Э������: %4d ", check_sum, ttl, proto);
		//printf("ICMP \n");
